...
-(void)initView
{
    ...
    _array = [[NSMutableArray alloc] initWithObjects:[UIImage imageNamed:@"bike"],
              [UIImage imageNamed:@"tu8601_5.jpg"],
              [UIImage imageNamed:@"tu8601_7.jpg"],
              [UIImage imageNamed:@"tu8601_10.jpg"],
              [UIImage imageNamed:@"btn_1_a"],
              [UIImage imageNamed:@"airplane50"], nil];
